...
import (
	...
	pb "github.com/farit2000/shippy/shippy-service-consignment/proto/consignment"
...
func main() {
	...
	// Register service
	if err := pb.RegisterShipplyServiceHandler(service.Server(), &consignmentService{repo}); err != nil {
		log.Panic(err)
	}
